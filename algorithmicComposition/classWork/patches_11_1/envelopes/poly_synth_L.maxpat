...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 633.0, 137.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "+ 4."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 592.0, 137.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "+ 3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 556.0, 137.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "+ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 517.0, 137.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 517.0, 91.0, 123.0, 22.0 ],
					"style" : "",
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 594.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.25, 598.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 82.0, 103.0, 221.0, 22.0 ],
					"style" : "",
					"text" : "route pitch partial_amp partial_mult env"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 625.75, 496.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 484.0, 216.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 28.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 82.0, 249.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 135.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "mtof"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 91.5, 221.0, 102.0, 221.0 ],
					"order" : 3,
					"source" : [ "obj-56", 0 ]
				}
